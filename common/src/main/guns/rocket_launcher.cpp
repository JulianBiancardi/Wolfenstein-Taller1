...
//const int RocketLauncher::bullet_required = ConfigLoader::get_init_configs().rocket_launcher_bullet_required;
//const int RocketLauncher::base_precision = ConfigLoader::get_init_configs().rocket_launcher_base_precision;

RocketLauncher::RocketLauncher() {

}

int RocketLauncher::shoot(Player& player_shooting,
                          int& current_bullets,
                          Map& map) {
