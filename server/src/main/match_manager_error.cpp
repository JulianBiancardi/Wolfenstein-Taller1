...
MatchManagerError::MatchManagerError(const char* format, ...) noexcept {
  int _errno = errno;
...
const char* MatchManagerError::what() const noexcept { return error_msg; }

MatchManagerError::~MatchManagerError() {}
